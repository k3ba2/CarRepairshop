...
{
    public class CreateCarRepairshopCommandValidator : AbstractValidator<CreateCarRepairshopCommand>
    {

        public CreateCarRepairshopCommandValidator()
        {
            RuleFor(x => x.Name)
                .MinimumLength(2).WithMessage("Pole musi mieć co najmniej 2 znaki.")
                .MaximumLength(8).WithMessage("Pole nie może mieć więcej niż 8 znaków.")
