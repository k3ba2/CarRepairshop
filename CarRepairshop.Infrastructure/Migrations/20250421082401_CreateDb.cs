    ...
    public partial class CreateDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArchivedCarRepairshops", x => x.CarRepairshopId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "CarRepairshopOpeningHours",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarRepairshopOpeningHours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarRepairshopOpeningHours_CarRepairshops_CarRepairshopId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarRepairshopOpeningHours_CarRepairshopId",
